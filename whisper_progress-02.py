...
def transcribe_with_progress(audio_path: str, model_name: str, output_formats: tuple):
    ...
    # Уменьшаем размер чанка для CPU
    chunk_size = 30 * SAMPLE_RATE  # возвращаем к 30 секундам для CPU
    ...
    # (Optional) Detect language once to reuse for all segments
    language = None
    try:
